...
class AuthValidation
{
    public static function register(): bool
    {
        ...
        if (!isset($_POST['username']) || $_POST['username'] === '') {
            NotificationHelper::error('username', 'Vui lòng k để trống username  ');
            $is_valid = false;
        }
        if (!isset($_POST['password']) || $_POST['password'] === '') {
            NotificationHelper::error('password', 'Vui lòng k để trống password ');
            $is_valid = false;
        } else {
    ...
    public static function changePassword(): bool
    {
        ...
        if (!isset($_POST['old_password']) || $_POST['old_password'] === '') {
            NotificationHelper::error('old_password', 'Vui lòng k để trống mật khẩu cũ ');
            $is_valid = false;
        }
        if (!isset($_POST['new_password']) || $_POST['new_password'] === '') {
            NotificationHelper::error('password', 'Vui lòng k để trống mật khẩu mới ');
            $is_valid = false;
