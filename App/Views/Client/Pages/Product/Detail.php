...
class Detail extends BaseView
{
    public static function render($data = null)
    {
        ...
        <div class="container mt-5 mb-5">
            ...
            <div class="row">
                <div class="col-md-8">
                    <img src="<?= APP_URL ?>/public/uploads/products/<?= $data['product']['image'] ?>" alt="" width="80%"
                        class="img-padding">
                    <div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="border border-danger p-3">
                        ...
                        <div><img src="https://baobihuuco.com/wp-content/uploads/2019/04/icon-giao-hang-toan-quoc.jpg" alt=""
                                width="10%"> giao hàng nội thành từ 2-4 giờ</div>
                        <div><img
                                src="https://png.pngtree.com/png-vector/20220611/ourlarge/pngtree-gold-star-medal-png-image_4994571.png"
                                width="10%"> Đổi trả trong vòng 48 giờ nếu sản phẩm không đạt chất lượng cam kết</div>
                    </div>
                    <br>
                                ...
                                foreach ($data['comments'] as $item):
                                    ...
                                    <div class="d-flex flex-row comment-row m-t-0">
                                        <div class="p-4">
                                            ...
                                            if ($item['avatar']):
                                                ?>
                                                <img src="<?= APP_URL ?>/public/uploads/users/<?= $item['avatar'] ?>" alt="user" width="50"
                                                    class="rounded-circle">
                                                <?php
                                            else:
                                                ?>
                                                <img src="<?= APP_URL ?>/public/uploads/users/" alt="user" width="50"
                                                    class="rounded-circle">
