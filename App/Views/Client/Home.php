        ...
        <div class="row">
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Du_du.jpg" alt="" width="100%"height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Dau_tay.jpg" alt="" width="100%"height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Cam.jpg" alt="" width="100%"height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Trai_me.jpg" alt="" width="100%" height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Sau_rieng.jpg" alt="" width="100%" height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Trai_Bi.jpg" alt="" width="100%" height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Dua_hau.jpg" alt="" width="100%" height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              <a href="">
                <div class="img-index">
                  <img src="public/uploads/products/Chom_chom.jpg" alt="" width="100%" height="200px">
                </div>
                <div class="new">
                  <span>
                    Mới
