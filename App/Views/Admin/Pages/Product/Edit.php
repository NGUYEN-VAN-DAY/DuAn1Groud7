                            ...
                            <form class="form-horizontal" action="/admin/products/<?= $data['product']['id'] ?>" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control editsto" id="description" placeholder="Nhập mô tả" name="description"> <?= $data['product']['description'] ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-select shadow-none" style="width: 100%; height:36px;" id="is_feature" name="is_feature">
                                            <option value="" selected disabled>Vui lòng chọn</option>
                                            <option value="1" <?= ($data['product']['is_feature'] == 1 ? 'selected' : '') ?>>Mới</option>
                                            <option value="2" <?= ($data['product']['is_feature'] == 2 ? 'selected' : '') ?>>Hot</option>
                                            <option value="0" <?= ($data['product']['is_feature'] == 0 ? 'selected' : '') ?>>Bình thường</option>
