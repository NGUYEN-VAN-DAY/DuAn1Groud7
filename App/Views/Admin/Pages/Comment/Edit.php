                        ...
                        <div class="card">
                            <form class="form-horizontal" action="/admin/comments/<?= $data['id']?>" method="POST">
                                <div class="card-body">
                                    ...
                                    <input type="hidden" name="method" id="" value="">
                                   ...
                                   <label for="username">Tài khoản*</label>
                                        <input type="text" class="form-control" id="username" placeholder="Nhập tên bình luận" name="username" value="<?= $data['username'] ?>"disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="product_name">Sản phẩm*</label>
                                        <input type="text" class="form-control" id="product_name" placeholder="Nhập tên bình luận" name="product_name" value="<?= $data['product_name'] ?>"disabled >
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="date" placeholder="Nhập tên bình luận" name="date" value="<?= $data['date'] ?>" disabled>
                                    </div>
                                    <div class="form-group">
